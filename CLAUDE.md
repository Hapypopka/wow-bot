...
4. **Русские названия спеллов** — сверяй с SpellDatabase.md. Регистр важен, ё→е.
5. **Названия спеллов** — перед использованием нового спелла ОБЯЗАТЕЛЬНО проверь его точное название в SpellDatabase.md.
...
- `AllRotations.cs` — ВСЕ ротации в одном файле, per-class методы (Warrior(), Paladin(), etc.)
...
## Реализовано
- [x] **28 ротаций** — все классы, все спеки PvE
- [x] **Система баффов** — per-class (seal/blessing/aura только для палладина)
- [x] **UI оверлей** — тоглы спеллов, иконки, радио-выбор
- [x] **Persist настроек** — settings.json
